...
class Menu extends Component {
  ...
  launchDropdownMenu() {
    this.element = document.querySelectorAll('.header__menu-item_has-children'); // eslint-disable-line
    this.dropdownElement = Array.prototype.slice.call(this.element);
    this.children = document.querySelectorAll('.header__menu-item_has-children .header__menu-children a.header__menu-link'); // eslint-disable-line
    ...
    try {
      ...
      /* eslint no-console: 0 */
      console.error(`[DROPDOWN MENU]: There is no element '${this.dropdownElement}' in the DOM.`);
      return false;
    }
  }
